...
const setC4Type = function(c4TypeParam) {
  let sanitizedText = mermaid_core.sanitizeText$1(c4TypeParam, mermaid_core.getConfig());
...
const setTitle = function(txt) {
  let sanitizedText = mermaid_core.sanitizeText$1(txt, mermaid_core.getConfig());
  title = sanitizedText;
};
const c4Db = {
  addPersonOrSystem,
