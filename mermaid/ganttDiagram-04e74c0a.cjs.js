...
function labConvert(o) {
  ...
  if (!(o instanceof mermaid_core.Rgb)) o = mermaid_core.rgbConvert(o);
  var r = rgb2lrgb(o.r),
      g = rgb2lrgb(o.g),
      b = rgb2lrgb(o.b),
...
function interpolate(a, b) {
  var t = typeof b, c;
  return b == null || t === "boolean" ? mermaid_core.constant(b)
      : (t === "number" ? mermaid_core.interpolateNumber
      : t === "string" ? ((c = mermaid_core.color(b)) ? (b = c, mermaid_core.interpolateRgb) : mermaid_core.interpolateString)
      : b instanceof mermaid_core.color ? mermaid_core.interpolateRgb
...
function hcl(hue) {
  return function(start, end) {
    var h = hue((start = hcl$1(start)).h, (end = hcl$1(end)).h),
        c = mermaid_core.nogamma(start.c, end.c),
        l = mermaid_core.nogamma(start.l, end.l),
        opacity = mermaid_core.nogamma(start.opacity, end.opacity);
    return function(t) {
      start.h = h(t);
      start.c = c(t);
      start.l = l(t);
...
var interpolateHcl = hcl(mermaid_core.hue);
