...
function isSymbol(value) {
  return typeof value == 'symbol' ||
    (mermaid_core.isObjectLike(value) && mermaid_core.baseGetTag(value) == symbolTag$3);
}
...
var symbolProto$2 = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : undefined,
...
function assignValue(object, key, value) {
  ...
  if (!(hasOwnProperty$8.call(object, key) && mermaid_core.eq(objValue, value)) ||
...
function isIterateeCall(value, index, object) {
  ...
  if (type == 'number'
        ? (mermaid_core.isArrayLike(object) && isIndex(index, object.length))
...
function arrayLikeKeys(value, inherited) {
  var isArr = mermaid_core.isArray(value),
      isArg = !isArr && mermaid_core.isArguments(value),
      isBuff = !isArr && !isArg && mermaid_core.isBuffer(value),
      isType = !isArr && !isArg && !isBuff && mermaid_core.isTypedArray(value),
...
function baseKeysIn(object) {
  ...
  var isProto = mermaid_core.isPrototype(object),
      result = [];
...
/** Built-in value references. */
var spreadableSymbol = mermaid_core.Symbol ? mermaid_core.Symbol.isConcatSpreadable : undefined;
...
function isFlattenable(value) {
  return mermaid_core.isArray(value) || mermaid_core.isArguments(value) ||
...
function isPlainObject(value) {
  if (!mermaid_core.isObjectLike(value) || mermaid_core.baseGetTag(value) != objectTag$2) {
    return false;
  }
...
/** Built-in value references. */
var Buffer = moduleExports ? mermaid_core.root$1.Buffer : undefined,
...
/** Used to convert symbols to primitives and strings. */
var symbolProto$1 = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : undefined,
...
function initCloneObject(object) {
  return (typeof object.constructor == 'function' && !mermaid_core.isPrototype(object))
...
function baseClone(value, bitmask, customizer, key, object, stack) {
  ...
  if (isArr) {
    ...
    var tag = mermaid_core.getTag(value),
...
/** Used to convert symbols to primitives and strings. */
var symbolProto = mermaid_core.Symbol ? mermaid_core.Symbol.prototype : undefined,
...
function baseIsEqualDeep(object, other, bitmask, customizer, equalFunc, stack) {
  var objIsArr = mermaid_core.isArray(object),
      othIsArr = mermaid_core.isArray(other),
      objTag = objIsArr ? arrayTag : mermaid_core.getTag(object),
      othTag = othIsArr ? arrayTag : mermaid_core.getTag(other);
  ...
  if (isSameTag && !objIsObj) {
    stack || (stack = new Stack);
    return (objIsArr || mermaid_core.isTypedArray(object))
...
function hasPath(object, path, hasFunc) {
  ...
  return !!length && mermaid_core.isLength(length) && isIndex(key, length) &&
    (mermaid_core.isArray(object) || mermaid_core.isArguments(object));
}
...
function baseIteratee(value) {
  ...
  if (typeof value == 'object') {
    return mermaid_core.isArray(value)
...
var defaults = baseRest(function(object, sources) {
  ...
  while (++index < length) {
    ...
    while (++propsIndex < propsLength) {
      ...
      if (value === undefined ||
          (mermaid_core.eq(value, objectProto$1[key]) && !hasOwnProperty$1.call(object, key))) {
...
function assignMergeValue(object, key, value) {
  if ((value !== undefined && !mermaid_core.eq(object[key], value)) ||
      (value === undefined && !(key in object))) {
    baseAssignValue(object, key, value);
  }
}
...
function baseMergeDeep(object, source, key, srcIndex, mergeFunc, customizer, stack) {
  ...
  if (isCommon) {
    var isArr = mermaid_core.isArray(srcValue),
        isBuff = !isArr && mermaid_core.isBuffer(srcValue),
        isTyped = !isArr && !isBuff && mermaid_core.isTypedArray(srcValue);
    ...
    else if (isPlainObject(srcValue) || mermaid_core.isArguments(srcValue)) {
      newValue = objValue;
...
function baseMap(collection, iteratee) {
  var index = -1,
      result = mermaid_core.isArrayLike(collection) ? Array(collection.length) : [];
...
function baseSet(object, path, value, customizer) {
  ...
  while (nested != null && ++index < length) {
    ...
    if (index != lastIndex) {
      ...
      if (newValue === undefined) {
        newValue = mermaid_core.isObject(objValue)
          ? objValue
...
function reduce(collection, iteratee, accumulator) {
  var func = mermaid_core.isArray(collection) ? arrayReduce : baseReduce,
 ...
 */
var createSet = !(mermaid_core.Set && (1 / setToArray(new mermaid_core.Set([,-0]))[1]) == INFINITY) ? noop : function(values) {
  return new mermaid_core.Set(values);
};
