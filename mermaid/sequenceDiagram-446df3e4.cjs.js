...
const parseBoxData = function(str) {
  ...
  const boxData = {
    color,
    text: title !== void 0 ? mermaid_core.sanitizeText$1(title.replace(/^:?(?:no)?wrap:/, ""), mermaid_core.getConfig()) : void 0,
...
const addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = mermaid_core.sanitizeText$1(text.text, mermaid_core.getConfig());
